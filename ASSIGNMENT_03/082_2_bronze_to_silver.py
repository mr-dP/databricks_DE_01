...
health_data_path = "dbfs:/mnt/health-updates/bronze/health_status_updates.csv"
...
health_data = health_data.select(
    "STATUS_UPDATE_ID",
    "PATIENT_ID",
    to_date("DATE_PROVIDED", "MM/dd/yyyy").alias("DATE_PROVIDED"),
    "FEELING_TODAY",
    "IMPACT",
...
deltaTable = DeltaTable.forPath(spark, "dbfs:/mnt/health-updates/silver/health_data")

deltaTable.alias("tgt").merge(
    health_data.alias("src"), "tgt.status_update_id = src.status_update_id"
).whenMatchedUpdate(
    set={
